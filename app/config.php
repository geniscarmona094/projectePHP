<?php
    ...
    define('APP_BASE_PATH','C:\xampp\htdocs\practicaPHP\projectePHP');
    define('APP_SESSION_NAME','NIA_APP_SESSID');
    define('APP_SESSION_TIME',7200);

    define('DB_DSN','mysql:host=localhost;port=3306;dbname=isitec;charset=utf8');
    define('DB_USER','root');
    define('DB_PASS','');
